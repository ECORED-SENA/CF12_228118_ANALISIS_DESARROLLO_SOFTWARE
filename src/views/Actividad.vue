  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Desarrollo de interfaces gráficas en #[em software]
        p.mb-4 Identificar los elementos esenciales en el proceso de desarrollo de interfaces gráficas para aplicaciones de #[em software].
